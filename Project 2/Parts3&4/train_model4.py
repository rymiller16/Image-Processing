...
def main():
    ...
    #model 4  (non linear - ELU, HardSigmoid, LeakyReLU, Sigmoid, ReLU)
    #let's try 10 layers with other non linear activation functions mixed in
...
#momentum = 0.9
    ...
    plt.savefig("Epoch Graph - Model 4.png")
    ...
    for i in range(5): 
        ...
        plt.savefig("Filtered Images Model4 - #%d.png" %i)
    ...
    plt.savefig("Filtered Image through Model4.png")
