...
def main():
    ...
    #model2 (can play with adding other stuff between layers)
    ...
    ## ************* Start of your Code *********************** ## momentum = 0.09
...
#plotting loss array
    ...
    plt.savefig("Epoch Graph - Model 2.png")
    ...
    for i in range(5): 
        ...
        plt.savefig("Filtered Images Model2 - #%d.png" %i)
    ...
    plt.savefig("Filtered Image through Model2.png")
