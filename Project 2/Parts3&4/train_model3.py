...
def main():
    ...
    #model 3  (non linear - ELU, HardSigmoid, LeakyReLU, Sigmoid, ReLU)
...
#momentum = 0.9
    ...
    plt.savefig("Epoch Graph - Model 3.png")
    ...
    for i in range(5): 
        ...
        plt.savefig("Filtered Images Model3 - #%d.png" %i)
    ...
    plt.savefig("Filtered Image through Model3.png")
